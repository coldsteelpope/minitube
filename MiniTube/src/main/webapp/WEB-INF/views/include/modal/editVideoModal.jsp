...
<button type="button" class="btn btn-lg btn-success w-100 mt-3"
	...
	data-bs-target="#staticBackdrop${video.getV_id()}">EDIT</button>

<!-- Modal -->
<div class="modal fade" id="staticBackdrop${video.getV_id()}"
	data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
	aria-labelledby="staticBackdropLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h1 class="modal-title fs-5" id="staticBackdropLabel">${video.getV_title()}</h1>
				<button type="button" class="btn-close" data-bs-dismiss="modal"
					aria-label="Close"></button>
			</div>
			<form
				action="<c:url value="/video/edit/" />${video.getV_id()}/${member.getM_id()}"
				...
				<div class="modal-body">
					<div>
						<label style="border-left: 5px solid #1ce783;" for="title_label"><strong
							...
							class="form-control mt-2" value="${video.getV_title()}" />
					</div>
					<div class="mt-2">
						...
						<textarea required id="description_label" name="v_description"
							placeholder="description" class="form-control mt-2">${video.getV_description()}</textarea>
					</div>
					<div class="mt-2">
						<label style="border-left: 5px solid #1ce783;"
